...
|---|---|---|
| `codex-header-rewrite-v0.25.8.so` | `codex-header-rewrite` | `0.25.8` |
...
sudo install -m 0644 codex-header-rewrite-linux-amd64.so \
  /CLIProxyAPI/plugins/codex-header-rewrite-v0.25.8.so
```
